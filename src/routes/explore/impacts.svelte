<script>
	...
	import { CURRENT_GEOGRAPHY, CURRENT_SCENARIOS, CURRENT_INDICATOR, AVAILABLE_INDICATORS } from '$lib/../stores/store.js';
	...
	$: buildRequests($AVAILABLE_INDICATORS, $CURRENT_GEOGRAPHY, $CURRENT_SCENARIOS);
</script>
