<script>
  import { IS_COMBINATION_AVAILABLE, IS_EMPTY_SELECTION, CURRENT_GEOGRAPHY_UID, CURRENT_INDICATOR_UID, CURRENT_INDICATOR_OPTION_VALUES, CURRENT_SCENARIOS_UID, CURRENT_INDICATOR_OPTIONS, CURRENT_INDICATOR_PARAMETERS } from '$stores/state.js';
  import { PATH_IMPACT, URL_PATH_INDICATOR, URL_PATH_GEOGRAPHY, URL_PATH_SCENARIOS } from '$config';
  ...
  $: query = !isDisabled && buildURL(PATH_IMPACT, { [URL_PATH_INDICATOR]: $CURRENT_INDICATOR_UID, [URL_PATH_GEOGRAPHY]: $CURRENT_GEOGRAPHY_UID, [URL_PATH_SCENARIOS]: $CURRENT_SCENARIOS_UID, ...$CURRENT_INDICATOR_OPTION_VALUES });

  $: console.log({$CURRENT_INDICATOR_OPTION_VALUES, $CURRENT_INDICATOR_PARAMETERS, $CURRENT_INDICATOR_OPTIONS })
