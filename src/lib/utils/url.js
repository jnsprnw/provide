...
import { URL_PATH_FREQUENCY, URL_PATH_INDICATOR_VALUE, URL_PATH_CERTAINTY_LEVEL, URL_PATH_LEVEL_OF_IMPACT, PATH_AVOID, URL_PATH_INDICATOR, URL_PATH_GEOGRAPHY, URL_PATH_SCENARIOS, URL_PATH_TIME, URL_PATH_REFERENCE, URL_PATH_SPATIAL } from '$config';
...
export function buildURL(url, params = {}) {
  const obj = {
    ...
    [URL_PATH_SCENARIOS]: (params[URL_PATH_SCENARIOS] ?? []).sort(),
